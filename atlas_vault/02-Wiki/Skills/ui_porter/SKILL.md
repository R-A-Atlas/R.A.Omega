---
name: UI/UX Porter
description: Ports UI patterns from atlas_dashboard_v4.html into ra_omega_app.html using React + Tailwind
type: reference
agent: E4
...
architecture of ra_omega_app.html. Translate custom CSS → Tailwind.
