...
#   Say: "Read AGENTS.md completely, then run a full audit:
...
When unsure which doc wins:
  Runtime safety + repo conventions  →  AGENTS.md (this file)
...
### SAFE TO MODIFY
  ...
  .Codex/hooks/                Session continuity and pre-commit context hooks.
  .Codex/commands/             Slash commands for repeatable workflows.
...
### PRIORITY 0 — YOU run the Supabase migration (not Codex)
...
## 13. Codex SHORTCUTS
  ...
  Codex --continue   Resume last session (best way to start every day)

### How to start each session
  Codex --continue
  Then: "Read AGENTS.md completely, run a full audit, tell me next priority."
...
## 14. RULES THAT CANNOT BE BROKEN
  ...
  9. INCIDENT LOGGER — After any bug fix or rollback in the same session: ask "What broke, what caused it,
     ...
     Impact, Prevention with Y/N for AGENTS.md + C2 Security test, Related Files). Full template: ATLAS_25_CURSOR_AGENTS.md
