# tests/test_watchlist_alert_report.py
# Watchlist Alert Report — existence and structure tests
# Run: python -m pytest tests/test_watchlist_alert_report.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/watchlist_alert"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "watchlist-alert-report", "SKILL.md"
)
