# tests/test_pdf_report_agent.py
# PDF Report Agent — existence and structure tests
# Run: python -m pytest tests/test_pdf_report_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/pdf"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "pdf-report-agent", "SKILL.md"
)
