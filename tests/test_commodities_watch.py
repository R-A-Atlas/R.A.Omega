# tests/test_commodities_watch.py
# Commodities Watch — existence and structure tests
# Run: python -m pytest tests/test_commodities_watch.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "trading/commodities"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "commodities-watch", "SKILL.md"
)
