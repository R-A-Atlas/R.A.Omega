# tests/test_bond_yield_curve.py
# Bond Yield Curve — existence and structure tests
# Run: python -m pytest tests/test_bond_yield_curve.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "trading/bond_yields"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "bond-yield-curve", "SKILL.md"
)
