# tests/test_ira_401k_limit_bot.py
# IRA 401k Limit Bot — existence and structure tests
# Run: python -m pytest tests/test_ira_401k_limit_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/retirement_limits"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "ira-401k-limit-bot", "SKILL.md"
)
