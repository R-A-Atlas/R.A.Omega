...
# PowerPoint Agent — existence and structure tests
# Run: python -m pytest tests/test_powerpoint_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/powerpoint"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "powerpoint-agent", "SKILL.md"
)
