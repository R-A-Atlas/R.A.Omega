# tests/test_congressional_trade_watcher.py
# Congressional Trade Watcher — existence and structure tests
# Run: python -m pytest tests/test_congressional_trade_watcher.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/congress_trades"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "congressional-trade-watcher", "SKILL.md"
)
