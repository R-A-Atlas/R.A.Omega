# tests/test_rental_yield_calculator.py
# Rental Yield Calculator — existence and structure tests
# Run: python -m pytest tests/test_rental_yield_calculator.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "realestate/rental_yield"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "rental-yield-calculator", "SKILL.md"
)
