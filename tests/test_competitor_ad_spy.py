# tests/test_competitor_ad_spy.py
# Competitor Ad Spy — existence and structure tests
# Run: python -m pytest tests/test_competitor_ad_spy.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/ad_spy"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "competitor-ad-spy", "SKILL.md"
)
