...
# Execution Sandbox — existence and structure tests
# Run: python -m pytest tests/test_execution_sandbox.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/sandbox"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "execution-sandbox", "SKILL.md"
)
