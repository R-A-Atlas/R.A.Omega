# tests/test_local_file_creator.py
# Local File Creator — existence and structure tests
# Run: python -m pytest tests/test_local_file_creator.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/local_file_creator"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "local-file-creator", "SKILL.md"
)
