# tests/test_ui_ux_porter.py
# UI UX Porter — existence and structure tests
# Run: python -m pytest tests/test_ui_ux_porter.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "engineering/ui_porter"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "ui-ux-porter", "SKILL.md"
)
