...
# Eval Scorer — existence and structure tests
# Run: python -m pytest tests/test_eval_scorer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "engineering/eval_scorer"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "eval-scorer", "SKILL.md"
)
