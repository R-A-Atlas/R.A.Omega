...
# Review Aggregator — existence and structure tests
# Run: python -m pytest tests/test_review_aggregator.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/reviews"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "review-aggregator", "SKILL.md"
)
