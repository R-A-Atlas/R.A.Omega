# tests/test_content_repurposer_bot.py
# Content Repurposer Bot — existence and structure tests
# Run: python -m pytest tests/test_content_repurposer_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/content"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "content-repurposer-bot", "SKILL.md"
)
