# tests/test_engagement_rater.py
# Engagement Rater — existence and structure tests
# Run: python -m pytest tests/test_engagement_rater.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/engagement"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "engagement-rater", "SKILL.md"
)
