# tests/test_email_deliverability_monitor.py
# Email Deliverability Monitor — existence and structure tests
# Run: python -m pytest tests/test_email_deliverability_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/email_health"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "email-deliverability-monitor", "SKILL.md"
)
