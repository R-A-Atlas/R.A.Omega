...
# Cross Asset Correlation — existence and structure tests
# Run: python -m pytest tests/test_cross_asset_correlation.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/correlation"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "cross-asset-correlation", "SKILL.md"
)
