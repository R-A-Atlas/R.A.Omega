# tests/test_freelance_rate_indexer.py
# Freelance Rate Indexer — existence and structure tests
# Run: python -m pytest tests/test_freelance_rate_indexer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "business/freelance_rates"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "freelance-rate-indexer", "SKILL.md"
)
