# tests/test_consumer_protection_watch.py
# Consumer Protection Watch — existence and structure tests
# Run: python -m pytest tests/test_consumer_protection_watch.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "legal/consumer_protection"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "consumer-protection-watch", "SKILL.md"
)
