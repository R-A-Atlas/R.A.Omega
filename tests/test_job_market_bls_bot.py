# tests/test_job_market_bls_bot.py
# Job Market BLS Bot — existence and structure tests
# Run: python -m pytest tests/test_job_market_bls_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/jobs"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "job-market-bls-bot", "SKILL.md"
)
