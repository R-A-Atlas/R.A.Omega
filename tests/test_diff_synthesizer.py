# tests/test_diff_synthesizer.py
# Diff Synthesizer — existence and structure tests
# Run: python -m pytest tests/test_diff_synthesizer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/diff_synthesizer"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "diff-synthesizer", "SKILL.md"
)
