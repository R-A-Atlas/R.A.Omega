# tests/test_alert_voice_notifier.py
# Alert Voice Notifier — existence and structure tests
# Run: python -m pytest tests/test_alert_voice_notifier.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "voice/notifier"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "alert-voice-notifier", "SKILL.md"
)
