# tests/test_regime_change_detector.py
# Regime Change Detector — existence and structure tests
# Run: python -m pytest tests/test_regime_change_detector.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/regime_detector"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "regime-change-detector", "SKILL.md"
)
