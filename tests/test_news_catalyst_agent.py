# tests/test_news_catalyst_agent.py
# News Catalyst Agent — existence and structure tests
# Run: python -m pytest tests/test_news_catalyst_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/news_catalyst"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "news-catalyst-agent", "SKILL.md"
)
