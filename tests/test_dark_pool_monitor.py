# tests/test_dark_pool_monitor.py
# Dark Pool Monitor — existence and structure tests
# Run: python -m pytest tests/test_dark_pool_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "trading/dark_pool"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "dark-pool-monitor", "SKILL.md"
)
