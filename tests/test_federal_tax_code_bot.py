# tests/test_federal_tax_code_bot.py
# Federal Tax Code Bot — existence and structure tests
# Run: python -m pytest tests/test_federal_tax_code_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "legal/federal_tax"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "federal-tax-code-bot", "SKILL.md"
)
