# tests/test_cost_of_living_indexer.py
# Cost of Living Indexer — existence and structure tests
# Run: python -m pytest tests/test_cost_of_living_indexer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/col_indexer"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "cost-of-living-indexer", "SKILL.md"
)
