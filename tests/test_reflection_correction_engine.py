# tests/test_reflection_correction_engine.py
# Reflection Correction Engine — existence and structure tests
# Run: python -m pytest tests/test_reflection_correction_engine.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/reflection"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "reflection-correction-engine", "SKILL.md"
)
