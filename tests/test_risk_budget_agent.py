# tests/test_risk_budget_agent.py
# Risk Budget Agent — existence and structure tests
# Run: python -m pytest tests/test_risk_budget_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/risk_budget"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "risk-budget-agent", "SKILL.md"
)
