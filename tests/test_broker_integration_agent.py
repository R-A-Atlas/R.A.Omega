# tests/test_broker_integration_agent.py
# Broker Integration Agent — existence and structure tests
# Run: python -m pytest tests/test_broker_integration_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/broker"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "broker-integration-agent", "SKILL.md"
)
