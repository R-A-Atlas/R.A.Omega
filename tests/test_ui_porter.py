...
def test_e4_chat_modes_and_settings_present():
    ...
    assert "queryBody.source_strictness" in content, "source strictness not sent to /query"
    ...
    assert "form.append('source_strictness'" in content, "source strictness not sent to /voice/query"
