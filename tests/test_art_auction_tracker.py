# tests/test_art_auction_tracker.py
# Art Auction Tracker — existence and structure tests
# Run: python -m pytest tests/test_art_auction_tracker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "alternative/art"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "art-auction-tracker", "SKILL.md"
)
