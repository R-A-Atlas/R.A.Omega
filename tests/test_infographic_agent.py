# tests/test_infographic_agent.py
# Infographic Agent — existence and structure tests
# Run: python -m pytest tests/test_infographic_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/infographic"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "infographic-agent", "SKILL.md"
)
