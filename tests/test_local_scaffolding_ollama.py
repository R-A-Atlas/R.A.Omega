# tests/test_local_scaffolding_ollama.py
# Local Scaffolding Ollama — existence and structure tests
# Run: python -m pytest tests/test_local_scaffolding_ollama.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/local_scaffold"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "local-scaffolding-ollama", "SKILL.md"
)
