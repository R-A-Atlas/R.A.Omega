# tests/test_student_debt_monitor.py
# Student Debt Monitor — existence and structure tests
# Run: python -m pytest tests/test_student_debt_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/student_debt"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "student-debt-monitor", "SKILL.md"
)
