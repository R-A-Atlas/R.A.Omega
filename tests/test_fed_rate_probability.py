# tests/test_fed_rate_probability.py
# Fed Rate Probability — existence and structure tests
# Run: python -m pytest tests/test_fed_rate_probability.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/fed_watch"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "fed-rate-probability", "SKILL.md"
)
