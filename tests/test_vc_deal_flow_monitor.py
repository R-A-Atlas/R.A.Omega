# tests/test_vc_deal_flow_monitor.py
# VC Deal Flow Monitor — existence and structure tests
# Run: python -m pytest tests/test_vc_deal_flow_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "business/vc_deals"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "vc-deal-flow-monitor", "SKILL.md"
)
