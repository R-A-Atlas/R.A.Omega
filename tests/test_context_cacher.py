# tests/test_context_cacher.py
# Context Cacher — existence and structure tests
# Run: python -m pytest tests/test_context_cacher.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/context_cacher"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "context-cacher", "SKILL.md"
)
