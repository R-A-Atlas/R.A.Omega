# tests/test_labor_law_monitor.py
# Labor Law Monitor — existence and structure tests
# Run: python -m pytest tests/test_labor_law_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "legal/labor_law"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "labor-law-monitor", "SKILL.md"
)
