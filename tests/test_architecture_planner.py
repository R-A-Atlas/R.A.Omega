...
# Architecture Planner — existence and structure tests
# Run: python -m pytest tests/test_architecture_planner.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/arch_planner"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "architecture-planner", "SKILL.md"
)
