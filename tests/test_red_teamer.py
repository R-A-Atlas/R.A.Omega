# tests/test_red_teamer.py
# Red Teamer — existence and structure tests
# Run: python -m pytest tests/test_red_teamer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "engineering/red_teamer"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "red-teamer", "SKILL.md"
)
