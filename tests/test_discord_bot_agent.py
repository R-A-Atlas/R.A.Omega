# tests/test_discord_bot_agent.py
# Discord Bot Agent — existence and structure tests
# Run: python -m pytest tests/test_discord_bot_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/discord"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "discord-bot-agent", "SKILL.md"
)
