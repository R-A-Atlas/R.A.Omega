# tests/test_sec_edgar_bot.py
# SEC EDGAR Bot — existence and structure tests
# Run: python -m pytest tests/test_sec_edgar_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "legal/sec_edgar"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "sec-edgar-bot", "SKILL.md"
)
