# tests/test_franchise_evaluator.py
# Franchise Evaluator — existence and structure tests
# Run: python -m pytest tests/test_franchise_evaluator.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "business/franchise"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "franchise-evaluator", "SKILL.md"
)
