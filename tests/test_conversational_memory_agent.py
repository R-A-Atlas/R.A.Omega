# tests/test_conversational_memory_agent.py
# Conversational Memory Agent — existence and structure tests
# Run: python -m pytest tests/test_conversational_memory_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "voice/memory"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "conversational-memory-agent", "SKILL.md"
)
