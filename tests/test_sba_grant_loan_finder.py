# tests/test_sba_grant_loan_finder.py
# SBA Grant Loan Finder — existence and structure tests
# Run: python -m pytest tests/test_sba_grant_loan_finder.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "business/sba"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "sba-grant-loan-finder", "SKILL.md"
)
