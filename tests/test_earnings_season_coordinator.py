# tests/test_earnings_season_coordinator.py
# Earnings Season Coordinator — existence and structure tests
# Run: python -m pytest tests/test_earnings_season_coordinator.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/earnings_coord"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "earnings-season-coordinator", "SKILL.md"
)
