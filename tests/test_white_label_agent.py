# tests/test_white_label_agent.py
# White Label Agent — existence and structure tests
# Run: python -m pytest tests/test_white_label_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/white_label"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "white-label-agent", "SKILL.md"
)
