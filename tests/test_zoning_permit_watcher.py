# tests/test_zoning_permit_watcher.py
# Zoning Permit Watcher — existence and structure tests
# Run: python -m pytest tests/test_zoning_permit_watcher.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "realestate/zoning"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "zoning-permit-watcher", "SKILL.md"
)
