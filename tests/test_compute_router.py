...
# Compute Router — existence and structure tests
# Run: python -m pytest tests/test_compute_router.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/router"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "compute-router", "SKILL.md"
)
