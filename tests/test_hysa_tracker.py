# tests/test_hysa_tracker.py
# HYSA Tracker — existence and structure tests
# Run: python -m pytest tests/test_hysa_tracker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/hysa"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "hysa-tracker", "SKILL.md"
)
