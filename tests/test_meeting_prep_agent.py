# tests/test_meeting_prep_agent.py
# Meeting Prep Agent — existence and structure tests
# Run: python -m pytest tests/test_meeting_prep_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "voice/meeting_prep"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "meeting-prep-agent", "SKILL.md"
)
