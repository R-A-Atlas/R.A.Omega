# tests/test_evals_benchmarking_supervisor.py
# Evals Benchmarking Supervisor — existence and structure tests
# Run: python -m pytest tests/test_evals_benchmarking_supervisor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/eval_supervisor"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "evals-benchmarking-supervisor", "SKILL.md"
)
