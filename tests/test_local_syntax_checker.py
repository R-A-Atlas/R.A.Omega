# tests/test_local_syntax_checker.py
# Local Syntax Checker — existence and structure tests
# Run: python -m pytest tests/test_local_syntax_checker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/local_syntax"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "local-syntax-checker", "SKILL.md"
)
