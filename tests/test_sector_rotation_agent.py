# tests/test_sector_rotation_agent.py
# Sector Rotation Agent — existence and structure tests
# Run: python -m pytest tests/test_sector_rotation_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/sector_rotation"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "sector-rotation-agent", "SKILL.md"
)
