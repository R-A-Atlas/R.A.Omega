# tests/test_crm_sync_agent.py
# CRM Sync Agent — existence and structure tests
# Run: python -m pytest tests/test_crm_sync_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/crm_sync"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "crm-sync-agent", "SKILL.md"
)
