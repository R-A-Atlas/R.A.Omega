# tests/test_geopolitical_tariff_tracker.py
# Geopolitical Tariff Tracker — existence and structure tests
# Run: python -m pytest tests/test_geopolitical_tariff_tracker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/tariffs"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "geopolitical-tariff-tracker", "SKILL.md"
)
