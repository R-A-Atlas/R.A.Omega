# tests/test_ecommerce_trends_bot.py
# Ecommerce Trends Bot — existence and structure tests
# Run: python -m pytest tests/test_ecommerce_trends_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "business/ecommerce"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "ecommerce-trends-bot", "SKILL.md"
)
