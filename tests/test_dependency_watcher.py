# tests/test_dependency_watcher.py
# Dependency Watcher — existence and structure tests
# Run: python -m pytest tests/test_dependency_watcher.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "engineering/dep_watcher"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "dependency-watcher", "SKILL.md"
)
