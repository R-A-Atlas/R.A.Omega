# tests/test_compliance_archive_agent.py
# Compliance Archive Agent — existence and structure tests
# Run: python -m pytest tests/test_compliance_archive_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/compliance"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "compliance-archive-agent", "SKILL.md"
)
