# tests/test_physical_metals_bot.py
# Physical Metals Bot — existence and structure tests
# Run: python -m pytest tests/test_physical_metals_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "alternative/metals"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "physical-metals-bot", "SKILL.md"
)
