# tests/test_supply_chain_indexer.py
# Supply Chain Indexer — existence and structure tests
# Run: python -m pytest tests/test_supply_chain_indexer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/supply_chain"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "supply-chain-indexer", "SKILL.md"
)
