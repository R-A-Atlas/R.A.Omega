# tests/test_sentiment_divergence_agent.py
# Sentiment Divergence Agent — existence and structure tests
# Run: python -m pytest tests/test_sentiment_divergence_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/sentiment_div"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "sentiment-divergence-agent", "SKILL.md"
)
