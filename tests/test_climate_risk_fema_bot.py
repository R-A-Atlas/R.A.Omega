# tests/test_climate_risk_fema_bot.py
# Climate Risk FEMA Bot — existence and structure tests
# Run: python -m pytest tests/test_climate_risk_fema_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/climate_risk"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "climate-risk-fema-bot", "SKILL.md"
)
