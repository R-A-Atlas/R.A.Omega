# tests/test_residential_scout.py
# Residential Scout — existence and structure tests
# Run: python -m pytest tests/test_residential_scout.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "realestate/residential"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "residential-scout", "SKILL.md"
)
