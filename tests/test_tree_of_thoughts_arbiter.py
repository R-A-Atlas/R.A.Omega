# tests/test_tree_of_thoughts_arbiter.py
# Tree of Thoughts Arbiter — existence and structure tests
# Run: python -m pytest tests/test_tree_of_thoughts_arbiter.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/tot_arbiter"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "tree-of-thoughts-arbiter", "SKILL.md"
)
