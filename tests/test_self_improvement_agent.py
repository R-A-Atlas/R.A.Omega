...
# Self Improvement Agent — existence and structure tests
# Run: python -m pytest tests/test_self_improvement_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/self_improvement"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "self-improvement-agent", "SKILL.md"
)
