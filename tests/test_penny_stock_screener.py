# tests/test_penny_stock_screener.py
# Penny Stock Screener — existence and structure tests
# Run: python -m pytest tests/test_penny_stock_screener.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "trading/penny_screener"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "penny-stock-screener", "SKILL.md"
)
