# tests/test_voice_input_whisper.py
# Voice Input Whisper — existence and structure tests
# Run: python -m pytest tests/test_voice_input_whisper.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "voice/input"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "voice-input-whisper", "SKILL.md"
)
