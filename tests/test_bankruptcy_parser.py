# tests/test_bankruptcy_parser.py
# Bankruptcy Parser — existence and structure tests
# Run: python -m pytest tests/test_bankruptcy_parser.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "legal/bankruptcy"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "bankruptcy-parser", "SKILL.md"
)
