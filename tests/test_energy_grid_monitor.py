# tests/test_energy_grid_monitor.py
# Energy Grid Monitor — existence and structure tests
# Run: python -m pytest tests/test_energy_grid_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/energy"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "energy-grid-monitor", "SKILL.md"
)
