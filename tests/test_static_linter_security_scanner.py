# tests/test_static_linter_security_scanner.py
# Static Linter Security Scanner — existence and structure tests
# Run: python -m pytest tests/test_static_linter_security_scanner.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/linter"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "static-linter-security-scanner", "SKILL.md"
)
