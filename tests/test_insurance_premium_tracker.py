# tests/test_insurance_premium_tracker.py
# Insurance Premium Tracker — existence and structure tests
# Run: python -m pytest tests/test_insurance_premium_tracker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/insurance"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "insurance-premium-tracker", "SKILL.md"
)
