# tests/test_personal_loan_screener.py
# Personal Loan Screener — existence and structure tests
# Run: python -m pytest tests/test_personal_loan_screener.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/personal_loans"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "personal-loan-screener", "SKILL.md"
)
