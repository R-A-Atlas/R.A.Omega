# tests/test_local_test_runner.py
# Local Test Runner — existence and structure tests
# Run: python -m pytest tests/test_local_test_runner.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/local_test_runner"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "local-test-runner", "SKILL.md"
)
