# tests/test_watch_market_bot.py
# Watch Market Bot — existence and structure tests
# Run: python -m pytest tests/test_watch_market_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "alternative/watches"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "watch-market-bot", "SKILL.md"
)
