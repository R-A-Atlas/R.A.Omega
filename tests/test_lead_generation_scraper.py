# tests/test_lead_generation_scraper.py
# Lead Generation Scraper — existence and structure tests
# Run: python -m pytest tests/test_lead_generation_scraper.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/lead_gen"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "lead-generation-scraper", "SKILL.md"
)
