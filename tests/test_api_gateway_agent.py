# tests/test_api_gateway_agent.py
# API Gateway Agent — existence and structure tests
# Run: python -m pytest tests/test_api_gateway_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/api_gateway"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "api-gateway-agent", "SKILL.md"
)
