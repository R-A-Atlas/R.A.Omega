# tests/test_commercial_property_bot.py
# Commercial Property Bot — existence and structure tests
# Run: python -m pytest tests/test_commercial_property_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "realestate/commercial"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "commercial-property-bot", "SKILL.md"
)
