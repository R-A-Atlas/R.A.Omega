# tests/test_state_tax_monitor.py
# State Tax Monitor — existence and structure tests
# Run: python -m pytest tests/test_state_tax_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "legal/state_tax"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "state-tax-monitor", "SKILL.md"
)
