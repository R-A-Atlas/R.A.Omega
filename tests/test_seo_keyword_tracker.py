# tests/test_seo_keyword_tracker.py
# SEO Keyword Tracker — existence and structure tests
# Run: python -m pytest tests/test_seo_keyword_tracker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/seo"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "seo-keyword-tracker", "SKILL.md"
)
