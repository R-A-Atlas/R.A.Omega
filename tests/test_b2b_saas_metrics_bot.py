# tests/test_b2b_saas_metrics_bot.py
# B2B SaaS Metrics Bot — existence and structure tests
# Run: python -m pytest tests/test_b2b_saas_metrics_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "business/saas_metrics"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "b2b-saas-metrics-bot", "SKILL.md"
)
