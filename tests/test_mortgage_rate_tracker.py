# tests/test_mortgage_rate_tracker.py
# Mortgage Rate Tracker — existence and structure tests
# Run: python -m pytest tests/test_mortgage_rate_tracker.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "realestate/mortgage_rates"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "mortgage-rate-tracker", "SKILL.md"
)
