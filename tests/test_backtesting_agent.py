# tests/test_backtesting_agent.py
# Backtesting Agent — existence and structure tests
# Run: python -m pytest tests/test_backtesting_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "intelligence/backtesting"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "backtesting-agent", "SKILL.md"
)
