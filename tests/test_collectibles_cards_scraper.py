# tests/test_collectibles_cards_scraper.py
# Collectibles Cards Scraper — existence and structure tests
# Run: python -m pytest tests/test_collectibles_cards_scraper.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "alternative/collectibles"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "collectibles-cards-scraper", "SKILL.md"
)
