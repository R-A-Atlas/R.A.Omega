# tests/test_nl_report_editor.py
# NL Report Editor — existence and structure tests
# Run: python -m pytest tests/test_nl_report_editor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "voice/report_editor"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "nl-report-editor", "SKILL.md"
)
