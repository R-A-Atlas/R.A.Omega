# tests/test_local_documentation_writer.py
# Local Documentation Writer — existence and structure tests
# Run: python -m pytest tests/test_local_documentation_writer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "compute/local_docs"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "local-documentation-writer", "SKILL.md"
)
