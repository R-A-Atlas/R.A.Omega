# tests/test_email_digest_agent.py
# Email Digest Agent — existence and structure tests
# Run: python -m pytest tests/test_email_digest_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/email_digest"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "email-digest-agent", "SKILL.md"
)
