# tests/test_airbnb_str_analyzer.py
# Airbnb STR Analyzer — existence and structure tests
# Run: python -m pytest tests/test_airbnb_str_analyzer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "realestate/str_analyzer"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "airbnb-str-analyzer", "SKILL.md"
)
