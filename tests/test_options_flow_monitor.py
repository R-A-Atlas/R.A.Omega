# tests/test_options_flow_monitor.py
# Options Flow Monitor — existence and structure tests
# Run: python -m pytest tests/test_options_flow_monitor.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "trading/options_flow"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "options-flow-monitor", "SKILL.md"
)
