# tests/test_auto_loan_scanner.py
# Auto Loan Scanner — existence and structure tests
# Run: python -m pytest tests/test_auto_loan_scanner.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/auto_loans"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "auto-loan-scanner", "SKILL.md"
)
