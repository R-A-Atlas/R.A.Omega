# tests/test_credit_card_optimizer.py
# Credit Card Optimizer — existence and structure tests
# Run: python -m pytest tests/test_credit_card_optimizer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "wealth/credit_cards"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "credit-card-optimizer", "SKILL.md"
)
