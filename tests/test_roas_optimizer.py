# tests/test_roas_optimizer.py
# ROAS Optimizer — existence and structure tests
# Run: python -m pytest tests/test_roas_optimizer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/roas"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "roas-optimizer", "SKILL.md"
)
