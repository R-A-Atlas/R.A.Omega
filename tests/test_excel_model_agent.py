# tests/test_excel_model_agent.py
# Excel Model Agent — existence and structure tests
# Run: python -m pytest tests/test_excel_model_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/excel"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "excel-model-agent", "SKILL.md"
)
