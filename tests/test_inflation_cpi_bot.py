# tests/test_inflation_cpi_bot.py
# Inflation CPI Bot — existence and structure tests
# Run: python -m pytest tests/test_inflation_cpi_bot.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "macro/inflation"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "inflation-cpi-bot", "SKILL.md"
)
