# tests/test_telegram_alert_agent.py
# Telegram Alert Agent — existence and structure tests
# Run: python -m pytest tests/test_telegram_alert_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/telegram"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "telegram-alert-agent", "SKILL.md"
)
