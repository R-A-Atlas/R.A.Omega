# tests/test_social_sentiment_analyzer.py
# Social Sentiment Analyzer — existence and structure tests
# Run: python -m pytest tests/test_social_sentiment_analyzer.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "growth/sentiment"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "social-sentiment-analyzer", "SKILL.md"
)
