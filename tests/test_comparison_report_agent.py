# tests/test_comparison_report_agent.py
# Comparison Report Agent — existence and structure tests
# Run: python -m pytest tests/test_comparison_report_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "documents/comparison"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "comparison-report-agent", "SKILL.md"
)
