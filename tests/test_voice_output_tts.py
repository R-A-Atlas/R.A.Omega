# tests/test_voice_output_tts.py
# Voice Output TTS — existence and structure tests
# Run: python -m pytest tests/test_voice_output_tts.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "voice/output"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "voice-output-tts", "SKILL.md"
)
