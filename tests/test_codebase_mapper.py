...
# Codebase Mapper — existence and structure tests
# Run: python -m pytest tests/test_codebase_mapper.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "cognitive/codebase_mapper"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "codebase-mapper", "SKILL.md"
)
