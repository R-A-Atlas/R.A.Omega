# tests/test_webhook_publisher_agent.py
# Webhook Publisher Agent — existence and structure tests
# Run: python -m pytest tests/test_webhook_publisher_agent.py -v

import os
import pytest

AGENT_DIR = os.path.join(
    os.path.dirname(__file__), "..", "atlas_agents", "platform/webhooks"
)
SKILL_FILE = os.path.join(
    os.path.dirname(__file__), "..",
    "atlas_vault", "02-Wiki", "Skills", "webhook-publisher-agent", "SKILL.md"
)
